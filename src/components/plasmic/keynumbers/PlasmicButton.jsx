...
import sty from "./PlasmicButton.module.css"; // plasmic-import: Dgb6fAOahpxm/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__dBLh)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg___0KOpG)}
                role={"img"}
              />
            ),
